...
export const dictionaries = {
  "pt-br": {
    ...
    forms: {
      ...
      successClient: "Mensagem comercial preparada no WhatsApp. O lead também ficou separado para controle interno.",
  ...
  es: {
    ...
    forms: {
      ...
      successClient: "Mensaje comercial preparado en WhatsApp. El lead también quedó separado para control interno.",
  ...
  en: {
    ...
    forms: {
      ...
      successClient: "Commercial message prepared in WhatsApp. The lead was also separated for internal control.",
