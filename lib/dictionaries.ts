...
export const dictionaries = {
  "pt-br": {
    ...
    forms: {
      ...
      emailDraftAttachmentNote: "Anexo selecionado: inclua o arquivo manualmente no rascunho, pois mailto não envia anexos.",
  ...
  es: {
    ...
    forms: {
      ...
      emailDraftAttachmentNote: "Archivo seleccionado: adjúntalo manualmente en el borrador, ya que mailto no envía adjuntos.",
  ...
  en: {
    ...
    forms: {
      ...
      emailDraftAttachmentNote: "File selected: attach it manually in the draft because mailto cannot send attachments.",
